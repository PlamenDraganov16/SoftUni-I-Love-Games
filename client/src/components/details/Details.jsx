                ...
                <div className="header-and-image">
                    ...
                    <div className="summary-section">
                        ...
                        <p className="text-summary">
                            ...
                            Between,
                            players embark on an epic quest to become the Elden Lord, exploring a vast open world designed by
                            Hidetaka Miyazaki,
                            with worldbuilding contributed by fantasy author George R. R. Martin. The game features challenging
                            combat,
